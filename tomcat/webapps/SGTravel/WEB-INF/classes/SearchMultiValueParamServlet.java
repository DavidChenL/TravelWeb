   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         if (city == null || startCity == null) {
            out.println("<p align='center'>Please go back and search again. </p></div></section><div class='footer'> <p> IM2073 Course Project: Yet Another Trip Advisor.<br/>Presented by Liangyu and Lixian <br/><br/></p> </div></body></html>");
            return; // Exit doGet()
        }
...
//
       ...
       //}
         ...
         out.println("</div> </div></section><div class='footer'> <p> IM2073 Course Project: Yet Another Trip Advisor.<br/>Presented by Liangyu and Lixian <br/><br/></p> </div></body></html>");
