...
public class PlanDetailsServlet extends HttpServlet {  // JDK 6 and above only
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         out.println("</div></div></session><!--========================== Footer ============================--> <div class='footer'> <p> IM2073 Course Project: Yet Another Trip Advisor.<br/>Presented by Liangyu and Lixian <br/><br/></p> </div></body></html>");
